...
{
    public class PurchaseTransactionRepositoryFactory
    {
        public static IPurchaseTransactionRepository GetRepository()
        {
            switch (Settings.GetRepositoryType())
            {
                case "QA":
                    return new PurchaseTransactionRepositoryMock();
                case "PROD":
